...
```json
{
  ...
  "response": {
    "body": {
      ...
      "url": "/api/users/{{request.pathParams.id}}"
    }
  }
}
```
...
```json
{
  ...
  "unixSeconds": 1705315800,
  "unixMillis": 1705315800000
}
```
...
```json
{
  ...
  "response": {
    ...
    "headers": {
      ...
      "Location": "/api/orders/{{uuid.short}}",
...
- [Request Matching](request-matching.md) - Matching rules
- [Stateful Mocking](stateful-mocking.md) - CRUD simulation
