    ...
    },
    {
      ...
      "response": {
        ...
        "body": {
          "id": "{{request.pathParams.id}}",
          "name": "User {{request.pathParams.id}}",
          "email": "user{{request.pathParams.id}}@example.com"
        }
      }
    },
    {
...
- [CRUD API Example](crud-api.md) - Stateful CRUD simulation
- [Integration Testing](integration-testing.md) - Using mocks in tests
- [Request Matching](../guides/request-matching.md) - Advanced matching
