...
func TestInMemoryRequestLogger_List(t *testing.T) {
	...
	for i := 0; i < 5; i++ {
		logger.Log(&config.RequestLogEntry{
			Method: "GET",
			Path:   "/api/test",
		})
	}
...
func TestInMemoryRequestLogger_ListWithFilter(t *testing.T) {
	...
	// Log mixed entries
	logger.Log(&config.RequestLogEntry{Method: "GET", Path: "/api/users"})
	logger.Log(&config.RequestLogEntry{Method: "POST", Path: "/api/users"})
	logger.Log(&config.RequestLogEntry{Method: "GET", Path: "/api/orders"})
...
func TestInMemoryRequestLogger_ListWithLimit(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		logger.Log(&config.RequestLogEntry{Method: "GET", Path: "/api/test"})
	}
...
func TestInMemoryRequestLogger_Clear(t *testing.T) {
	...
	for i := 0; i < 5; i++ {
		logger.Log(&config.RequestLogEntry{Method: "GET"})
	}
...
func TestInMemoryRequestLogger_FIFOEviction(t *testing.T) {
	...
	logger.Log(&config.RequestLogEntry{Method: "GET", Path: "/first"})
	time.Sleep(1 * time.Millisecond)
	logger.Log(&config.RequestLogEntry{Method: "GET", Path: "/second"})
	time.Sleep(1 * time.Millisecond)
	logger.Log(&config.RequestLogEntry{Method: "GET", Path: "/third"})
	time.Sleep(1 * time.Millisecond)
	logger.Log(&config.RequestLogEntry{Method: "GET", Path: "/fourth"})
...
func TestInMemoryRequestLogger_FilterByMatchedID(t *testing.T) {
	...
	logger.Log(&config.RequestLogEntry{Method: "GET", MatchedMockID: "mock-1"})
	logger.Log(&config.RequestLogEntry{Method: "GET", MatchedMockID: "mock-2"})
	logger.Log(&config.RequestLogEntry{Method: "GET", MatchedMockID: ""}) // no match
...
func TestInMemoryRequestLogger_FilterByStatusCode(t *testing.T) {
	...
	logger.Log(&config.RequestLogEntry{Method: "GET", ResponseStatus: 200})
	logger.Log(&config.RequestLogEntry{Method: "GET", ResponseStatus: 404})
	logger.Log(&config.RequestLogEntry{Method: "GET", ResponseStatus: 200})
